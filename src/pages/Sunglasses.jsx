...
const Sunglasses = () => {
  ...
  const skletion = Array(6)
  console.log(skletion)
  useEffect(() => {
    const fetchSunglasses = async () => {
      try {
        ...
        setSunglassesData(data.products);
        setLoading(false);
      } catch (err) {
        console.log(err);
      }
  ...
  return (
    <div className="dark:bg-gray-950 py-4">
      ...
      <div className="text-center mb-10 max-w-[600px] mx-auto">
        <h1 className="text-3xl font-bold dark:text-gray-400">Sunglasses 😎</h1>
        <p className="text-3xl text-primary">Trendy & Stylish Sunglasses</p>
        <p className="text-xl text-gray-400">Explore the best sunglasses collection.</p>
      </div>
  ...
  src={item.images[0]} 
  alt={item.title} 
  className="h-[200px] w-[150px] object-cover rounded-md bg-gray-200 dark:bg-gray-100"
/>
