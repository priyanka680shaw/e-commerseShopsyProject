  ...
  return (
    <div className= " dark:bg-gray-950 py-4">
      ...
      <div className="text-center mb-10 max-w-[600px] mx-auto">
          <h1 className="text-3xl font-bold dark:text-gray-400">Women's Wear 👗</h1>
        <p className="text-3xl text-primary">Latest Women's Wear Collection</p>
      
        <p className="text-xl text-gray-400">Discover trendy and stylish outfits for women.</p>
      </div>
